...
public class ArbolBinario {
   ...
   public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println(" |-----------------------|-----------------------|");
            System.out.println(" | 1. mostrar la cadena de enteros | 8.              |");
            System.out.println(" | 2. mostrar la cadena de texto   | 9.              |");
            System.out.println(" | 3.                              | 10.             |");
            System.out.println(" | 4.                              | 20. Salir       |");
            System.out.println(" | 5.                              | 20. Salir       |");
